			...
			<form action="/Pati" class="layui-form layui-form-pane" "
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block ">
						<input type="text" name="action" id="" value="add" hidden="hidden" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="patino" required="required" class="layui-input" autocomplete="off"
							placeholder="请输入编号" />
					</div>
					...
					$.ajax({
						...
						success: function(data) {
							...
							$.each(data, function(i, item) {
								...
								$('#room').append("<option value='" + item.wardno + "'>第" +
									item.wardno + "病房</option>"); //往下拉菜单里添加元素
								form.render();
							})
						}
					});
